    ...
    public partial class Osoba : Form
    {
        ...
        private void TxtPopulate()
        {
            ...
            else
            {
                ...
                textBox_zvanje.Text = tabela.Rows[broj_sloga][7].ToString();
        ...
        private void button_izmeni_Click(object sender, EventArgs e)
        {
            ...
            naredba = naredba + "uloga = " + textBox_zvanje.Text + " ";
        ...
        private void button_dodaj_Click(object sender, EventArgs e)
        {
            ...
            naredba = naredba + textBox_zvanje.Text + ")";
            SqlConnection veza = Connect.connect();
            SqlCommand komanda = new SqlCommand(naredba, veza);
            try
            {
        ...
        private void label_adresa_Click(object sender, EventArgs e)
        {
